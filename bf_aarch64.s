...
; Failure paths say what went wrong. Without this the program exits
; silently and there is no way to tell a missing file from a bad read.
_err_open:
    adrp x1, msg_open
...
usage_len:  .equ    $$ - usage
msg_open:
    .ascii "bf: cannot open file\n"
msg_open_len:   .equ    $$ - msg_open
msg_read:
    .ascii "bf: read failed\n"
